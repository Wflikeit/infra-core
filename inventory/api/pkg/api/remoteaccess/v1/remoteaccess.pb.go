...
const file_remoteaccess_v1_remoteaccess_proto_rawDesc = "" +
	"\n" +
	"\"remoteaccess/v1/remoteaccess.proto\x12\x0fremoteaccess.v1\x1a\x1bbuf/validate/validate.proto\x1a\x18compute/v1/compute.proto\x1a\x0eent/opts.proto\x1a\x17infrainv/infrainv.proto\x1a\x16status/v1/status.proto\"\xcc\b\n" +
	...
	"\rsession_token\x18\b \x01(\tB\x10\xbaH\a\xd8\x01\x01r\x02\x10\x03\xba\xa6I\x02\b\x01R\fsessionToken\x12O\n" +
	...
	"\bpostgres\x12\tTIMESTAMPR\tupdatedAt:'\xb2\xf9\x03\x1d\n" +
	"\r\x12\ttenant_id\x18\x00\n" +
	"\f\x18\x01*\binstance\xba\xa6I\x02\b\x01J\x04\b\t\x10\vR\vtarget_hostR\vtarget_port*\xdf\x01\n" +
